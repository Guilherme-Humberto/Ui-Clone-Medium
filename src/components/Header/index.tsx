...
const Header: React.FC = () => {
  return (
      <div>
        ...
        <div id="logo-nav">
            <svg className="grant-logo" height="22" width="112" viewBox="0 0 111.5 22">
                <path
            ...
            <svg className="small-logo" width="35" height="35" viewBox="5 5 35 35">
                <path
        ...
        <div id="nav-text-bar">
            <button className="navs">Subscribe</button>
            <button className="navs">Write</button>
            <button className="navs">Sign in</button>
            <button className="navs-get-started">Get Started</button>
        </div>
    </div>
      </div>
  );
